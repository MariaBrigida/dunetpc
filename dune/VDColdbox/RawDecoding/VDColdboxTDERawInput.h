/*
    Input source driver for TDE coldbox data
    

 */
#ifndef VDColdboxTDERawInput_h
#define VDColdboxTDERawInput_h
...
//
//
class raw::VDColdboxTDERawInput
{
 public: 
  // Required constructor
  VDColdboxTDERawInput( fhicl::ParameterSet const &pset,
